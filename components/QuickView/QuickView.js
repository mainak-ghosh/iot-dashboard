...
const QuickViewItem = () => {
  return (
    <div className="h-24 w-40 border border-grey rounded-md bg-grey` text-dark-textLt shadow-lg p-4 m-2 hover:bg-accent hover:text-white-textLt cursor-pointer">
  ...
  return (
    <div className="mt-2">
      <div className="flex flex-row justify-between items-center hover:rounded cursor-pointer">
        <h1 className="pt-2 pb-2 text-lg font-semibold">
          Quick View
        </h1>
        <svg
